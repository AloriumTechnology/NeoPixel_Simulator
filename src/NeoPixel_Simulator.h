...
#ifndef NEOPIXEL_SIMULATOR_H
#define NEOPIXEL_SIMULATOR_H
...
class NeoPixel_Simulator {

 public:

  // Constructor: number of LEDs, pin number, LED type
  NeoPixel_Simulator(uint16_t n, uint8_t p=6, neoPixelType t=NEO_GRB + NEO_KHZ800);
  NeoPixel_Simulator(void);
  ~NeoPixel_Simulator();
